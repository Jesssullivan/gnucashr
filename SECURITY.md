...
If you discover a security vulnerability in gnucashr, please report it responsibly:
...
gnucashr reads GnuCash files directly. Be aware of these security considerations:

#### File Permissions

GnuCash files may contain sensitive financial data. Ensure appropriate file permissions:
...
The C++ components (Rcpp, RcppParallel, RcppArmadillo) are designed with safety in mind:
...
gnucashr depends on well-maintained packages. We monitor for security advisories in:
