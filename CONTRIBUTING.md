...
Thank you for your interest in contributing to gnucashr! This document
...
2.  **Install system dependencies:**
    ...
    The package requires a C++17 compiler and GNU make for the Rcpp
    components.
...
6.  **Submit a pull request** to the GitLab repository (preferred) or
    GitHub mirror
...
- **Issues:** [GitLab
  Issues](https://gitlab.com/tinyland/projects/gnucashr/-/issues)
- **Documentation:** [Package
  Website](https://tinyland.gitlab.io/projects/gnucashr)

## License

By contributing to gnucashr, you agree that your contributions will be
