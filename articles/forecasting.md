...
gnucashr provides a lazy forecasting system that builds computation
pipelines without executing until you call `collect()`. This enables
efficient scenario comparison, Monte Carlo simulation, and sensitivity
analysis.
...
sens_result$outcomes  # growth × expense matrix
