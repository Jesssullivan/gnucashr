...
gnucashr supports managing multiple GnuCash books for corporate
structures with multiple entities. The `BookCollection` class provides
consolidated reporting with automatic intercompany elimination.
...
gnucashr automatically identifies and eliminates intercompany
transactions:
